...
public class Marine extends BaseUnit {
    ...
    public Marine(String name, Position position, CombatHandler combatHandler) {
        super(name,GameConstants.MARINE_RANGE, position, GameConstants.MARINE_HEALTH_POINTS, GameConstants.MARINE_ENERGY_POINTS, GameConstants.MARINE_ATTACK_POINTS, GameConstants.MARINE_DEFENSE_POINTS, combatHandler);
    }
